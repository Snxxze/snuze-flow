...
- [ ] **Step 1: Database Migration Schema**
  * **ไฟล์:** [backend/migrations/000001_create_users_table.up.sql](file:///d:/Dowload%20Google/snuze-flow/backend/migrations/000001_create_users_table.up.sql)
...
- [ ] **Step 2: DTOs & Validation Tags**
  * **ไฟล์:** [backend/internal/dto/auth_dto.go](file:///d:/Dowload%20Google/snuze-flow/backend/internal/dto/auth_dto.go)
...
- [ ] **Step 3: Pure Domain Model**
  * **ไฟล์:** [backend/internal/domain/user.go](file:///d:/Dowload%20Google/snuze-flow/backend/internal/domain/user.go)
...
- [ ] **Step 4: Repository Layer (Database Access)**
  * **ไฟล์:** [backend/internal/repository/user_repository.go](file:///d:/Dowload%20Google/snuze-flow/backend/internal/repository/user_repository.go)
...
- [ ] **Step 5: Service Layer & Business Logic**
  * **ไฟล์:** [backend/internal/service/user_service.go](file:///d:/Dowload%20Google/snuze-flow/backend/internal/service/user_service.go)
  * **จุดสังเกต:** 
...
- [ ] **Step 6: JWT Auth Middleware**
  * **ไฟล์:** [backend/internal/middleware/auth.go](file:///d:/Dowload%20Google/snuze-flow/backend/internal/middleware/auth.go)
...
- [ ] **Step 7: HTTP Handlers & Swag Annotations**
  * **ไฟล์:** [backend/internal/handler/auth_handler.go](file:///d:/Dowload%20Google/snuze-flow/backend/internal/handler/auth_handler.go)
...
- [ ] **Step 8: Dependency Injection & Routing Entrypoint**
  * **ไฟล์:** [backend/cmd/api/main.go](file:///d:/Dowload%20Google/snuze-flow/backend/cmd/api/main.go)
...
- [ ] **Step 9: Auth Types & Zod Schemas**
  * **ไฟล์:** [frontend/src/features/auth/types/auth.ts](file:///d:/Dowload%20Google/snuze-flow/frontend/src/features/auth/types/auth.ts)
...
- [ ] **Step 10: Axios Interceptor Base Client**
  * **ไฟล์:** [frontend/src/services/api/apiClient.ts](file:///d:/Dowload%20Google/snuze-flow/frontend/src/services/api/apiClient.ts)
...
- [ ] **Step 11: Auth Service & Zod Validation**
  * **ไฟล์:** [frontend/src/features/auth/services/authService.ts](file:///d:/Dowload%20Google/snuze-flow/frontend/src/features/auth/services/authService.ts)
...
- [ ] **Step 12: Auth Context & Global State**
  * **ไฟล์:** [frontend/src/features/auth/context/AuthContext.tsx](file:///d:/Dowload%20Google/snuze-flow/frontend/src/features/auth/context/AuthContext.tsx)
...
- [ ] **Step 13: Route Guards (Security Boundary)**
  * **ไฟล์:** [frontend/src/routes/ProtectedRoute.tsx](file:///d:/Dowload%20Google/snuze-flow/frontend/src/routes/ProtectedRoute.tsx) & [GuestOnlyRoute.tsx](file:///d:/Dowload%20Google/snuze-flow/frontend/src/routes/GuestOnlyRoute.tsx)
...
- [ ] **Step 14: Auth UI Screens (View Orchestration)**
  * **ไฟล์:** [frontend/src/pages/auth/LoginPage.tsx](file:///d:/Dowload%20Google/snuze-flow/frontend/src/pages/auth/LoginPage.tsx) & [RegisterPage.tsx](file:///d:/Dowload%20Google/snuze-flow/frontend/src/pages/auth/RegisterPage.tsx)
...
- [ ] **Step 15: App Router Composition**
  * **ไฟล์:** [frontend/src/App.tsx](file:///d:/Dowload%20Google/snuze-flow/frontend/src/App.tsx)
